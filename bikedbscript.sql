...
insert into bikes values ('Colnago Dream Rabobank',60,'blue/orange',5500,'2002-07-
07',4300);
insert into bikes values ('Bianchi Evolution 3',58,'celeste',4800,'2003-11-
12',2000);
...
insert into bikes values ('Battaglin Carrera',60,'red/white',4000,'2001-03-
10',11200);
insert into bikes values ('Colnago V3Rs UAE',58,'black/red',10500,'2023-01-15',0);
insert into bikes values ('Gianni Motta Personal',59,'red/green',4400,'2000-05-
01',8700);
...
insert into bikes values ('Bianchi Corse Evo 4',58,'celeste',5700,'2004-12-
02',300);
...
insert into bikes values ('Ridley X-Fire 2012', 58, 'red/white',7500,'2011-09-
01',0);
insert into bikes values ('BMC SLC01 - Swiss',58,'red/black/white',8000,'2010-06-
23',0);
insert into bikes values ('Colnago C64 - Mapei',58,'blue/white',11000,'2022-11-
16',0);
select * from bikes;
